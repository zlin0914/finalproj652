...
worldmap <- ggplot(world_map, aes(x = long, y = lat, group = group, fill = Cases)) +
  ...
  labs(title = "Number of Accidents by Country with Fatal") +
  theme_void()
```
...
This plot represents the number of flight accidents cases (from 2008 - 2022) across the world for each country in the dataset, only with fatalities. The number of the flight accidents is represented by the color fill in the worldmap. The color closer to red means more cases occurred. From this plot, we can easily distinguish that United States had the highest number of cases from 2008 to 2022. Additionally, more flight accidents occurred in China and Russia compared to the other countries during the time frame. 
